...
implements IExpressionFloat {
    ...
    public String toString() {
        ...
        if (this.type.getIndexNames2() == null) {
            return "" + (Object)((Object)this.type) + "." + this.type.getIndexNames1()[this.index1];
        }
        return "" + (Object)((Object)this.type) + "." + this.type.getIndexNames1()[this.index1] + "." + this.type.getIndexNames2()[this.index2];
    }
}
