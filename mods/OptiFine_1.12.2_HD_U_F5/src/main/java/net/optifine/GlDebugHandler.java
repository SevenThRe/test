...
implements ARBDebugOutputCallback.Handler {
    public static void createDisplayDebug() throws LWJGLException {
        ...
        Display.create((PixelFormat)new PixelFormat().withDepthBits(24), (ContextAttribs)ca);
        ...
        ARBDebugOutput.glDebugMessageControlARB((int)4352, (int)4352, (int)4352, null, (boolean)true);
