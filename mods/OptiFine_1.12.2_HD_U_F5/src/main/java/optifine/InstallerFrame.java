    ...
    private JPanel getPanelCenter() {
        if (this.ivjPanelCenter == null) {
            try {
                ...
                this.ivjPanelCenter.add((Component)this.getLabelFolder(), this.getLabelFolder().getName());
                this.ivjPanelCenter.add((Component)this.getFieldFolder(), this.getFieldFolder().getName());
                this.ivjPanelCenter.add((Component)this.getButtonFolder(), this.getButtonFolder().getName());
            }
            catch (Throwable ivjExc) {
                this.handleException(ivjExc);
            }
    ...
    private JPanel getPanelBottom() {
        if (this.ivjPanelBottom == null) {
            try {
                ...
                this.ivjPanelBottom.add((Component)this.getButtonExtract(), this.getButtonExtract().getName());
