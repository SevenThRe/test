    ...
    public void initGui() {
        try {
            ...
            if (this.buttonSortDistance == null) {
                WaypointManagerItem.DistanceComparator distanceSort = new WaypointManagerItem.DistanceComparator((EntityPlayer)FMLClientHandler.instance().getClient().player, true);
