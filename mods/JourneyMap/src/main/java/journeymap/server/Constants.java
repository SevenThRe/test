...
public class Constants {
    ...
    public static boolean isDev(Entity sender) {
        return "a4eb5569-bf38-3aef-bc21-2dbd73d30851".equalsIgnoreCase(sender.getUniqueID().toString()) || "a2039b6c-5a3d-407d-b49c-091405062b85".equalsIgnoreCase(sender.getUniqueID().toString());
    }
