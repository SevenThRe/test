...
extends ContextHandler {
    ...
    public ServletContextHandler(int options2) {
    ...
    public ServletContextHandler(HandlerContainer parent, String contextPath, int options2) {
        this(parent, contextPath, null, null, null, null, options2);
    }
    ...
    public ServletContextHandler(HandlerContainer parent, String contextPath, SessionHandler sessionHandler, SecurityHandler securityHandler, ServletHandler servletHandler, ErrorHandler errorHandler, int options2) {
    ...
    void destroyFilter(Filter filter2) {
        this._objFactory.destroy(filter2);
    }
