...
Dumpable {
    ...
    protected void doStop() throws Exception {
        ...
        Iterator<Thread> iterator2 = this._joinLock;
    ...
    public void dump(Appendable out, String indent) throws IOException {
        ...
        for (final Thread thread : this._threads) {
            final StackTraceElement[] trace2 = thread.getStackTrace();
            ...
            if (this.isDetailedDump()) {
                threads.add(new Dumpable(){
                    ...
                    public void dump(Appendable out, String indent) throws IOException {
                        ...
                        if (!idle) {
                            ContainerLifeCycle.dump(out, indent, Arrays.asList(trace2));
                        }
                    }
            ...
            threads.add(thread.getId() + " " + thread.getName() + " " + (Object)((Object)thread.getState()) + " @ " + (trace2.length > 0 ? trace2[0] : "???") + (idle ? " IDLE" : "") + (p == 5 ? "" : " prio=" + p));
        }
