...
extends Holder<Filter> {
    ...
    public FilterHolder(Class<? extends Filter> filter2) {
        this(Source.EMBEDDED);
        this.setHeldClass(filter2);
    }

    public FilterHolder(Filter filter2) {
        this(Source.EMBEDDED);
    ...
    public synchronized void setFilter(Filter filter2) {
        ...
        this.setHeldClass(filter2.getClass());
        if (this.getName() == null) {
            this.setName(filter2.getClass().getName());
        }
    }
