...
implements Cloneable {
    ...
    public static String canonicalPath(String path) {
        ...
        ListIterator iterator2 = directories.listIterator();
        while (iterator2.hasNext()) {
            switch ((String)iterator2.next()) {
                case "./": 
                case ".": {
                    if (iterator2.hasNext() && ((String)directories.get(iterator2.nextIndex())).equals(SLASH)) break;
                    iterator2.remove();
                    break;
                }
                case "../": 
                case "..": {
                    ...
                    iterator2.remove();
                    if (((String)iterator2.previous()).equals(SLASH) && iterator2.nextIndex() == 0) {
                        return null;
                    }
                    iterator2.remove();
                }
        ...
        return String.join((CharSequence)"", directories);
    }
