...
extends AbstractLogger {
    ...
    public void warn(String msg, Object ... args2) {
        if (this._level <= 3) {
            ...
            this.format(buffer, ":WARN:", msg, args2);
    ...
    public void info(String msg, Object ... args2) {
        if (this._level <= 2) {
            StringBuilder buffer = new StringBuilder(64);
            this.format(buffer, ":INFO:", msg, args2);
            (this._stderr == null ? System.err : this._stderr).println(buffer);
        }
    }
    ...
    public void debug(String msg, Object ... args2) {
        if (this._level <= 1) {
            StringBuilder buffer = new StringBuilder(64);
            this.format(buffer, ":DBUG:", msg, args2);
            (this._stderr == null ? System.err : this._stderr).println(buffer);
        }
    }
    ...
    private void format(StringBuilder buffer, String level, String msg, Object ... args2) {
        long now = System.currentTimeMillis();
        int ms = (int)(now % 1000L);
        String d = _dateCache.formatNow(now);
        this.tag(buffer, d, ms, level);
        this.format(buffer, msg, args2);
    }
    ...
    private void format(StringBuilder builder, String msg, Object ... args2) {
        if (msg == null) {
            msg = "";
