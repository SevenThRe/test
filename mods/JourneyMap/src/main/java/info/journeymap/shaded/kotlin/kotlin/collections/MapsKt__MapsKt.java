...
import info.journeymap.shaded.kotlin.kotlin.collections.EmptyMap;
import info.journeymap.shaded.kotlin.kotlin.collections.MapsKt;
import info.journeymap.shaded.kotlin.kotlin.collections.MapsKt__MapsJVMKt;
...
extends MapsKt__MapsJVMKt {
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> $this$minus, @NotNull Iterable<? extends K> keys) {
        ...
        boolean bl3 = false;
        Map<K, V> map2 = $this$apply;
        Iterable<? extends K> iterable = keys;
        boolean bl4 = false;
    ...
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> $this$minus, @NotNull Sequence<? extends K> keys) {
        ...
        boolean bl3 = false;
        Map<K, V> map2 = $this$apply;
        Sequence<? extends K> sequence = keys;
        boolean bl4 = false;
