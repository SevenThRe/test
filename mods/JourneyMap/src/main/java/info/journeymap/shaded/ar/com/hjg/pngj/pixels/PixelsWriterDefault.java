...
import info.journeymap.shaded.ar.com.hjg.pngj.pixels.FiltersPerformance;
    ...
    protected void decideCurFilterType() {
        if (FilterType.isValidStandard(this.getFilterType())) {
            ...
            if (this.currentRow == this.adaptNextRow) {
                ...
                int n = skip = this.currentRow >= this.adaptSkipIncreaseSinceRow ? (int)Math.round((double)(this.currentRow - this.adaptSkipIncreaseSinceRow) * this.adaptSkipIncreaseFactor) : 0;
