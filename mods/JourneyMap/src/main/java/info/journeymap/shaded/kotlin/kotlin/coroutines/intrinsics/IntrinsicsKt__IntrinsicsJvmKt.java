...
class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Continuation<Unit> createCoroutineUnintercepted(@NotNull Function1<? super Continuation<? super T>, ? extends Object> $this$createCoroutineUnintercepted, @NotNull Continuation<? super T> completion) {
        ...
        if ($this$createCoroutineUnintercepted instanceof BaseContinuationImpl) {
            ...
            if (context$iv == EmptyCoroutineContext.INSTANCE) {
                ...
                continuation = new RestrictedContinuationImpl(probeCompletion, continuation2, $this$createCoroutineUnintercepted){
                    private int label;
                ...
                continuation = new ContinuationImpl(probeCompletion, context$iv, continuation3, context$iv, $this$createCoroutineUnintercepted){
                    private int label;
                    final /* synthetic */ Continuation $completion;
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnintercepted(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> $this$createCoroutineUnintercepted, R receiver, @NotNull Continuation<? super T> completion) {
        ...
        if ($this$createCoroutineUnintercepted instanceof BaseContinuationImpl) {
            ...
            if (context$iv == EmptyCoroutineContext.INSTANCE) {
                ...
                continuation = new RestrictedContinuationImpl(probeCompletion, continuation2, $this$createCoroutineUnintercepted, receiver){
                    private int label;
                    final /* synthetic */ Continuation $completion;
                ...
                continuation = new ContinuationImpl(probeCompletion, context$iv, continuation3, context$iv, $this$createCoroutineUnintercepted, receiver){
                    private int label;
                    final /* synthetic */ Continuation $completion;
                    final /* synthetic */ CoroutineContext $context;
                    final /* synthetic */ Function2 $this_createCoroutineUnintercepted$inlined;
    ...
    private static final <T> Continuation<Unit> createCoroutineFromSuspendFunction$IntrinsicsKt__IntrinsicsJvmKt(Continuation<? super T> completion, Function1<? super Continuation<? super T>, ? extends Object> block) {
        ...
        if (context == EmptyCoroutineContext.INSTANCE) {
            Continuation<T> continuation2 = completion;
            if (continuation2 == null) {
                throw new TypeCastException("null cannot be cast to non-null type kotlin.coroutines.Continuation<kotlin.Any?>");
            }
            continuation = new RestrictedContinuationImpl(block, completion, continuation2){
                private int label;
            ...
            continuation = new ContinuationImpl(block, completion, context, continuation3, context){
                private int label;
                final /* synthetic */ Function1 $block;
                final /* synthetic */ Continuation $completion;
                final /* synthetic */ CoroutineContext $context;
