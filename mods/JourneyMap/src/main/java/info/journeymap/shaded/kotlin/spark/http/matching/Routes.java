...
final class Routes {
    ...
    static void execute(RouteContext context) throws Exception {
        ...
        if (match != null) {
            ...
            Object object = content = context.routeMatcher().find(HttpMethod.get, context.uri(), context.acceptType()) != null ? "" : null;
        }
        if (target != null) {
            String contentStr;
            Object result = null;
            ...
            if (result != null && (content = result) instanceof String && !(contentStr = (String)content).equals("")) {
