...
import info.journeymap.shaded.kotlin.kotlin.KotlinNullPointerException;
import info.journeymap.shaded.kotlin.kotlin.SinceKotlin;
import info.journeymap.shaded.kotlin.kotlin.UninitializedPropertyAccessException;
...
public class Intrinsics {
    ...
    public static void checkNotNullParameter(Object value, String paramName) {
        if (value == null) {
            throw Intrinsics.sanitizeStackTrace(new NullPointerException(paramName));
        }
    }
