...
import info.journeymap.shaded.kotlin.kotlin.internal.PlatformImplementations;
...
@Metadata(mv={1, 1, 15}, bv={1, 0, 3}, k=2, d1={"\u0000\u001e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u0000\n\u0002\b\u0004\u001a \u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0005H\u0001\u001a\"\u0010\b\u001a\u0002H\t\"\n\b\u0000\u0010\t\u0018\u0001*\u00020\n2\u0006\u0010\u000b\u001a\u00020\nH\u0083\b\u00a2\u0006\u0002\u0010\f\u001a\b\u0010\r\u001a\u00020\u0005H\u0002\"\u0010\u0010\u0000\u001a\u00020\u00018\u0000X\u0081\u0004\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u000e"}, d2={"IMPLEMENTATIONS", "Linfo/journeymap/shaded/kotlin/kotlin/internal/PlatformImplementations;", "apiVersionIsAtLeast", "", "major", "", "minor", "patch", "castToBaseType", "T", "", "instance", "(Ljava/lang/Object;)Ljava/lang/Object;", "getJavaVersion", "info.journeymap.shaded.kotlin.kotlin-stdlib"})
public final class PlatformImplementationsKt {
    ...
    public static final boolean apiVersionIsAtLeast(int major, int minor, int patch2) {
        return KotlinVersion.CURRENT.isAtLeast(major, minor, patch2);
    }
    ...
    static {
        ...
        block22: {
            ...
            if (version >= 65544) {
                try {
                    Object obj = Class.forName("info.journeymap.shaded.kotlin.kotlin.internal.jdk8.JDK8PlatformImplementations").newInstance();
                    ...
                    try {
                        Object obj = Class.forName("info.journeymap.shaded.kotlin.kotlin.internal.JRE8PlatformImplementations").newInstance();
                        Intrinsics.checkExpressionValueIsNotNull(obj, "Class.forName(\"kotlin.in\u2026entations\").newInstance()");
                        Object obj4 = obj;
                        boolean bl5 = false;
                        try {
            ...
            if (version >= 65543) {
                try {
                    Object obj = Class.forName("info.journeymap.shaded.kotlin.kotlin.internal.jdk7.JDK7PlatformImplementations").newInstance();
                    Intrinsics.checkExpressionValueIsNotNull(obj, "Class.forName(\"kotlin.in\u2026entations\").newInstance()");
                    Object obj6 = obj;
                    boolean bl6 = false;
                    try {
                    ...
                    try {
                        Object obj = Class.forName("info.journeymap.shaded.kotlin.kotlin.internal.JRE7PlatformImplementations").newInstance();
                        Intrinsics.checkExpressionValueIsNotNull(obj, "Class.forName(\"kotlin.in\u2026entations\").newInstance()");
                        Object obj8 = obj;
                        boolean bl7 = false;
                        try {
