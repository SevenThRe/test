...
public class WindowUtils {
    ...
    extends NativeWindowUtils {
        ...
        private void fixWindowDragging(Window w2, String context2) {
            JRootPane p2;
            ...
            if (w2 instanceof RootPaneContainer && (oldDraggable = (Boolean)(p2 = ((RootPaneContainer)((Object)w2)).getRootPane()).getClientProperty(WDRAG)) == null) {
                ...
                if (w2.isDisplayable()) {
                    System.err.println(context2 + "(): To avoid content dragging, " + context2 + "() must be called before the window is realized, or " + WDRAG + " must be set to Boolean.FALSE before the window is realized.  If you really want content dragging, set " + WDRAG + " on the window's root pane to Boolean.TRUE before calling " + context2 + "() to hide this message.");
                }
            }
        }
        ...
        private void setBackgroundTransparent(Window w2, boolean transparent, String context2) {
            JRootPane rp2;
            ...
            this.fixWindowDragging(w2, context2);
        }
            ...
            protected void paintDirect(BufferedImage buf, Rectangle bounds) {
                ...
                try {
                    ...
                    if (this.hBitmap == null || !win.getSize().equals(this.bitmapSize)) {
                        ...
                        bmi.bmiHeader.biWidth = ww2;
                        bmi.bmiHeader.biHeight = wh2;
                        bmi.bmiHeader.biPlanes = 1;
                        bmi.bmiHeader.biBitCount = (short)32;
                        bmi.bmiHeader.biCompression = 0;
                        bmi.bmiHeader.biSizeImage = ww2 * wh2 * 4;
