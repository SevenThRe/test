...
extends Pointer {
    ...
    public AVHDRPlusColorTransformParams(Pointer p2) {
        super(p2);
    }
    ...
    public AVHDRPlusColorTransformParams getPointer(long i2) {
        return (AVHDRPlusColorTransformParams)new AVHDRPlusColorTransformParams(this).offsetAddress(i2);
    }
