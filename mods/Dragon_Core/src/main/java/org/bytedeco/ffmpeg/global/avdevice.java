...
extends org.bytedeco.ffmpeg.presets.avdevice {
    ...
    @NoException
    public static native AVInputFormat av_input_audio_device_next(AVInputFormat var0);

    @NoException
    public static native AVInputFormat av_input_video_device_next(AVInputFormat var0);

    @NoException
    public static native AVOutputFormat av_output_audio_device_next(AVOutputFormat var0);

    @NoException
    public static native AVOutputFormat av_output_video_device_next(AVOutputFormat var0);
    ...
    @NoException
    @Deprecated
    public static native int avdevice_capabilities_create(@Cast(value={"AVDeviceCapabilitiesQuery**"}) PointerPointer var0, AVFormatContext var1, @Cast(value={"AVDictionary**"}) PointerPointer var2);

    @NoException
    @Deprecated
    public static native int avdevice_capabilities_create(@ByPtrPtr AVDeviceCapabilitiesQuery var0, AVFormatContext var1, @ByPtrPtr AVDictionary var2);

    @NoException
    @Deprecated
    public static native void avdevice_capabilities_free(@Cast(value={"AVDeviceCapabilitiesQuery**"}) PointerPointer var0, AVFormatContext var1);

    @NoException
    @Deprecated
    public static native void avdevice_capabilities_free(@ByPtrPtr AVDeviceCapabilitiesQuery var0, AVFormatContext var1);
    ...
    @NoException
    public static native int avdevice_list_input_sources(AVInputFormat var0, @Cast(value={"const char*"}) BytePointer var1, AVDictionary var2, @Cast(value={"AVDeviceInfoList**"}) PointerPointer var3);

    @NoException
    public static native int avdevice_list_input_sources(AVInputFormat var0, @Cast(value={"const char*"}) BytePointer var1, AVDictionary var2, @ByPtrPtr AVDeviceInfoList var3);

    @NoException
    public static native int avdevice_list_input_sources(AVInputFormat var0, String var1, AVDictionary var2, @ByPtrPtr AVDeviceInfoList var3);

    @NoException
    public static native int avdevice_list_output_sinks(AVOutputFormat var0, @Cast(value={"const char*"}) BytePointer var1, AVDictionary var2, @Cast(value={"AVDeviceInfoList**"}) PointerPointer var3);

    @NoException
    public static native int avdevice_list_output_sinks(AVOutputFormat var0, @Cast(value={"const char*"}) BytePointer var1, AVDictionary var2, @ByPtrPtr AVDeviceInfoList var3);

    @NoException
    public static native int avdevice_list_output_sinks(AVOutputFormat var0, String var1, AVDictionary var2, @ByPtrPtr AVDeviceInfoList var3);
