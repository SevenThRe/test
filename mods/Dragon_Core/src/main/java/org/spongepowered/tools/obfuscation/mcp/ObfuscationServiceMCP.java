...
implements IObfuscationService {
    ...
    public Set<String> getSupportedOptions() {
        return ImmutableSet.of((Object)REOBF_SRG_FILE, (Object)REOBF_EXTRA_SRG_FILES, (Object)REOBF_NOTCH_FILE, (Object)REOBF_EXTRA_NOTCH_FILES, (Object)OUT_SRG_SRG_FILE, (Object)OUT_NOTCH_SRG_FILE, (Object[])new String[0]);
    }
    ...
    public Collection<ObfuscationTypeDescriptor> getObfuscationTypes(IMixinAnnotationProcessor ap2) {
        ...
        if (!ap2.getOptions("mappingTypes").contains("tsrg")) {
            list.add((Object)new ObfuscationTypeDescriptor(SEARGE, REOBF_SRG_FILE, REOBF_EXTRA_SRG_FILES, OUT_SRG_SRG_FILE, ObfuscationEnvironmentMCP.class));
        }
        list.add((Object)new ObfuscationTypeDescriptor(NOTCH, REOBF_NOTCH_FILE, REOBF_EXTRA_NOTCH_FILES, OUT_NOTCH_SRG_FILE, ObfuscationEnvironmentMCP.class));
        return list.build();
    }
}
