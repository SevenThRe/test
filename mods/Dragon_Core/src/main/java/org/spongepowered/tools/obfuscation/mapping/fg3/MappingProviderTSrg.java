        ...
        for (String line : this.inputMappings) {
            ...
            if (parts.length > 1) {
                ...
                if (parts.length == 2) {
                    to2 = parts[1];
                    if (from.endsWith("/")) {
                        packageMap.forcePut((Object)from.substring(0, from.length() - 1), (Object)to2.substring(0, to2.length() - 1));
                        continue;
                    }
                    classMap.forcePut((Object)from, (Object)to2);
                    fromClass = from;
                    toClass = to2;
                    continue;
                }
                if (parts.length <= 2) continue;
                to2 = (String)classMap.get((Object)from);
                if (to2 == null) {
                    throw new IllegalStateException("Error parsing TSRG file, found inline member before class mapping: " + line);
                }
                if (parts.length == 3) {
                    fieldMap.forcePut((Object)new MappingField(from, parts[1]), (Object)new MappingField(to2, parts[2]));
                    continue;
                }
                if (parts.length == 4) {
                    methodMap.forcePut((Object)new MappingMethod(from, parts[1], parts[2]), (Object)new MappingMethodLazy(to2, parts[3], parts[2], this));
                    continue;
                }
                throw new IllegalStateException("Error parsing TSRG file, too many arguments: " + line);
            }
