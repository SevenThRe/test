...
public final class Bytecode {
    ...
    public static void dumpClass(byte[] bytes) {
        ...
        CheckClassAdapter.verify((ClassReader)cr2, (boolean)true, (PrintWriter)new PrintWriter(System.out));
    }
    ...
    public static String generateDescriptor(Object returnType, Object ... args) {
        ...
        for (Object arg : args) {
            sb2.append(Bytecode.toDescriptor(arg));
        }
    ...
    public static void compareBridgeMethods(MethodNode a2, MethodNode b2) {
        ListIterator ia2 = a2.instructions.iterator();
        ListIterator ib2 = b2.instructions.iterator();
        int index = 0;
            ...
            if (!(na2 instanceof LabelNode)) {
                if (na2 instanceof MethodInsnNode) {
                    ...
                    if (na2 instanceof VarInsnNode) {
                        ...
                        TypeInsnNode tb2 = (TypeInsnNode)nb2;
                        if (ta2.getOpcode() == 192 && !ta2.desc.equals(tb2.desc)) {
