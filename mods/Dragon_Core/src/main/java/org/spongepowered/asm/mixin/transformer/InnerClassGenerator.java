...
implements IClassGenerator {
    ...
    extends ClassRemapper {
        ...
        public InnerClassAdapter(ClassVisitor cv2, InnerClassInfo info) {
            super(ASM.API_VERSION, cv2, (Remapper)info);
            this.info = info;
        }
        ...
        public void visitSource(String source, String debug) {
            ...
            av2.visit("mixin", (Object)this.info.getOwner().toString());
            av2.visit("name", (Object)this.info.getOriginalName().substring(this.info.getOriginalName().lastIndexOf(47) + 1));
            av2.visitEnd();
        }
