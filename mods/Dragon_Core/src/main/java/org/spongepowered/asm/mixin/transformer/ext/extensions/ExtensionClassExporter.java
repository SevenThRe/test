...
implements IExtension {
    ...
    public ExtensionClassExporter(MixinEnvironment env) {
        ...
        try {
            ...
            logger.debug("Error cleaning class output directory: {}", new Object[]{ex2.getMessage()});
        }
    }
    ...
    private IDecompiler initDecompiler(MixinEnvironment env, File outputPath) {
        ...
        try {
            ...
            logger.info("Fernflower could not be loaded, exported classes will not be decompiled. {}: {}", new Object[]{th2.getClass().getSimpleName(), th2.getMessage()});
            return null;
        }
    }
