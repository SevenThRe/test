...
implements ITargetClassContext {
    ...
    void processDebugTasks() {
        ...
        boolean bl2 = this.forceExport = classDebugAnnotation != null && Boolean.TRUE.equals(Annotations.getValue(classDebugAnnotation, "export"));
    ...
    void addSuppressed(InvalidMixinException ex2) {
        this.suppressedExceptions.add(ex2);
    }
