    ...
    void loadConnectors() {
        ...
        for (String connectorClassName : this.connectorClasses) {
            ...
            try {
                ...
                logger.warn("Error loading Mixin Connector [" + connectorClassName + "]", (Throwable)ex3);
            }
        }
    ...
    void initConnectors() {
        for (IMixinConnector connector : this.connectors) {
            try {
                ...
                logger.warn("Error initialising Mixin Connector [" + connector.getClass().getName() + "]", (Throwable)ex2);
            }
        }
    }
}
