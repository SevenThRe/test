...
implements IMixinContext {
    ...
    void transformMethod(MethodNode method) {
        ...
        try {
            ...
            throw new InvalidMixinException(this, "Unexpecteded " + ex3.getClass().getSimpleName() + " whilst transforming the mixin class:", (Throwable)ex3, this.activities);
        }
    }
    ...
    void postApply(String transformedName, ClassNode targetClass) {
        ...
        try {
            ...
            throw new InvalidMixinException(this, "Unexpecteded " + ex4.getClass().getSimpleName() + " whilst transforming the mixin class:", (Throwable)ex4, this.activities);
        }
    }
