...
import org.yaml.snakeyamla.LoaderOptions;
import org.yaml.snakeyamla.TypeDescription;
import org.yaml.snakeyamla.composer.Composer;
import org.yaml.snakeyamla.constructor.BaseConstructor;
import org.yaml.snakeyamla.constructor.Constructor;
import org.yaml.snakeyamla.emitter.Emitable;
import org.yaml.snakeyamla.emitter.Emitter;
import org.yaml.snakeyamla.error.YAMLException;
import org.yaml.snakeyamla.events.Event;
import org.yaml.snakeyamla.introspector.BeanAccess;
import org.yaml.snakeyamla.nodes.Node;
import org.yaml.snakeyamla.nodes.Tag;
import org.yaml.snakeyamla.parser.ParserImpl;
import org.yaml.snakeyamla.reader.StreamReader;
import org.yaml.snakeyamla.reader.UnicodeReader;
import org.yaml.snakeyamla.representer.Representer;
import org.yaml.snakeyamla.resolver.Resolver;
import org.yaml.snakeyamla.serializer.Serializer;
...
public class Yaml {
    ...
    public <T> T load(InputStream io2) {
        return (T)this.loadFromReader(new StreamReader(new UnicodeReader(io2)), Object.class);
    }

    public <T> T load(Reader io2) {
        return (T)this.loadFromReader(new StreamReader(io2), Object.class);
    }

    public <T> T loadAs(Reader io2, Class<T> type) {
        return (T)this.loadFromReader(new StreamReader(io2), type);
    }
    ...
    public void addTypeDescription(TypeDescription td2) {
        this.constructor.addTypeDescription(td2);
        this.representer.addTypeDescription(td2);
    }
