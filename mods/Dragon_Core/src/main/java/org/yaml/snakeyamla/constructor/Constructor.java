...
extends SafeConstructor {
    ...
    public Constructor(TypeDescription theRoot, Collection<TypeDescription> moreTDs, LoaderOptions loadingConfig) {
        ...
        if (moreTDs != null) {
            for (TypeDescription td2 : moreTDs) {
                this.addTypeDescription(td2);
            }
        }
    }
    ...
    protected Class<?> getClassForNode(Node node) {
        ...
        if (classForTag == null) {
            ...
            try {
                cl2 = this.getClassForName(name);
            }
            catch (ClassNotFoundException e2) {
                throw new YAMLException("Class not found: " + name);
            }
            this.typeTags.put(node.getTag(), cl2);
            return cl2;
        }
        return classForTag;
    }
        ...
        public Object construct(Node node) {
            ...
            if (!possibleConstructors.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    parameterTypes[index] = e2.getClass();
                    ++index;
                }
                ...
                if (type.isPrimitive() || type == String.class || Number.class.isAssignableFrom(type) || type == Boolean.class || Date.class.isAssignableFrom(type) || type == Character.class || type == BigInteger.class || type == BigDecimal.class || Enum.class.isAssignableFrom(type) || Tag.BINARY.equals(node.getTag()) || Calendar.class.isAssignableFrom(type) || type == UUID.class) {
                    ...
                    if (javaConstructor == null) {
                        try {
                            ...
                            throw new YAMLException("No single argument constructor found for " + type + " : " + ie2.getMessage());
                        }
                    }
                    if (oneArgCount == 1) {
    ...
    implements Construct {
        ...
        private Construct getConstructor(Node node) {
            Class<?> cl2 = Constructor.this.getClassForNode(node);
            node.setType(cl2);
        ...
        protected Object constructJavaBean2ndStep(MappingNode node, Object object) {
            ...
            for (NodeTuple tuple : nodeValue) {
                ...
                try {
                    ...
                    boolean bl2 = typeDetected = memberDescription != null ? memberDescription.setupPropertyType(key, valueNode) : false;
