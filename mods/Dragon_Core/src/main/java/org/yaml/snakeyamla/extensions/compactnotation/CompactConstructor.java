...
import org.yaml.snakeyamla.extensions.compactnotation.CompactData;
    ...
    public CompactData getCompactData(String scalar) {
        ...
        if (m2.matches()) {
            ...
            for (int i2 = 0; i2 < names.length; ++i2) {
                ...
                Matcher sm2 = PROPERTY_NAME_PATTERN.matcher(section);
                if (sm2.matches()) {
                    String name = sm2.group(1);
                    String value = sm2.group(2).trim();
