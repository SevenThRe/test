...
import org.yaml.snakeyamla.events.ImplicitTuple;
...
import org.yaml.snakeyamla.parser.Parser;
import org.yaml.snakeyamla.parser.ParserException;
import org.yaml.snakeyamla.parser.Production;
import org.yaml.snakeyamla.parser.VersionTagsTuple;
import org.yaml.snakeyamla.reader.StreamReader;
import org.yaml.snakeyamla.scanner.Scanner;
import org.yaml.snakeyamla.scanner.ScannerImpl;
...
implements Parser {
    ...
    private Event parseNode(boolean block, boolean indentlessSequence) {
        ...
        if (this.scanner.checkToken(Token.ID.Alias)) {
            ...
            event = null;
            boolean bl2 = implicit = tag == null || tag.equals("!");
