...
import org.yaml.snakeyamla.introspector.GenericProperty;
import org.yaml.snakeyamla.util.ArrayUtils;
...
extends GenericProperty {
    ...
    public Object get(Object object) {
        try {
            ...
            throw new YAMLException("Unable to find getter for property '" + this.property.getName() + "' on object " + object + ":" + e2);
        }
    }
