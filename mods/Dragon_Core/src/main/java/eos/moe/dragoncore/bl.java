...
extends Gui {
    ...
    private Minecraft q = Minecraft.getMinecraft();
    private byte b;
    private int o;
    private int y;
    private boolean k;
    ...
    public void draw(int a2, int a3) {
        bl a4;
        a4.q.renderEngine.bindTexture(sk.v);
        if (a4.inBounds(a2, a3)) {
            Gui.drawRect((int)a4.o, (int)a4.y, (int)(a4.o + 9), (int)(a4.y + 9), (int)-2130706433);
        ...
        if (a4.k) {
            a4.drawTexturedModalRect(a4.o, a4.y, (a4.b - 1) * 9, 18, 9, 9);
        }
    ...
    private /* synthetic */ void ALLATORIxDEMO(int a2, int a3) {
        ...
        int a6 = a4.q.fontRenderer.getStringWidth(a5);
        bl.drawRect((int)(a2 + 8), (int)(a3 + 10), (int)(a2 + 9 + a6), (int)(a3 + 20), (int)-16777216);
        a4.q.fontRenderer.drawString(a5, a2 + 9, a3 + 11, 0xFFFFFF);
    }
