...
public class qia {
    ...
    public static void ALLATORIxDEMO(InputEvent.KeyInputEvent a2) throws IOException {
        if (Keyboard.isKeyDown((int)23) && Keyboard.isKeyDown((int)25)) {
            ...
            Minecraft.func_71410_x().field_71439_g.func_145747_a((ITextComponent)new TextComponentString("\u00a76\u5df2\u4e3a\u4f60\u8f93\u51fa\u624b\u4e2d\u7269\u54c1\u7684NBT\u603b\u548c,\u5176\u4e2d\u6fcf(se)\u4e3a\u989c\u8272\u7b26\u53f7"));
            Minecraft.func_71410_x().field_71439_g.func_145747_a((ITextComponent)new TextComponentString(dj.ALLATORIxDEMO(Minecraft.func_71410_x().field_71439_g.field_71071_by.func_70448_g(), false, false).replace("\u00a7", "\u6fcf")));
        }
