...
public class jz {
    ...
    private static /* synthetic */ void ALLATORIxDEMO(EntityLivingBase a2, xz a3, float a4) {
        ...
        if (a2.isEntityAlive()) {
            boolean a6;
            a5 = Interpolations.lerp(a2.prevLimbSwingAmount, a2.limbSwingAmount, a4);
            if (a5 > 1.0f) {
                a5 = 1.0f;
            }
    ...
    private static /* synthetic */ void ALLATORIxDEMO(EntityPlayer a2, xz a3, float a4) {
        ...
        EnumHandSide a7 = a2.getPrimaryHand();
        EnumHandSide a8 = a7 == EnumHandSide.RIGHT ? EnumHandSide.LEFT : EnumHandSide.RIGHT;
        ItemStack a9 = a2.getHeldItemMainhand();
        ItemStack a10 = a2.getHeldItemOffhand();
        Item a11 = a2.getActiveItemStack().getItem();
        ModelBiped.ArmPose a12 = jz.ALLATORIxDEMO(a2, a9);
        ModelBiped.ArmPose a13 = jz.ALLATORIxDEMO(a2, a10);
        EnumHandSide enumHandSide = a5 = a2.getActiveHand() == EnumHand.MAIN_HAND ? a7 : a8;
        ...
        } else if (jz.ALLATORIxDEMO(a9.getItem()) || a9.isEmpty()) {
            if (a9.isEmpty()) {
                if (a6.k() < 60.0f) {
    ...
    private static /* synthetic */ ModelBiped.ArmPose ALLATORIxDEMO(EntityPlayer a2, ItemStack a3) {
        if (!a3.isEmpty()) {
            if (a2.getItemInUseCount() > 0) {
                EnumAction a4 = a3.getItemUseAction();
