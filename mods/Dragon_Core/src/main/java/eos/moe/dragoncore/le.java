...
extends Gui {
    ...
    public le(aj a2, int a3, int a4) {
        ...
        a5.c = a3;
        a5.b = a4;
        a5.v = Minecraft.func_71410_x();
        a5.k = !a2.ALLATORIxDEMO.func_82582_d();
        a5.y = (a2.ALLATORIxDEMO.func_82582_d() ? "\u4fdd\u5b58 " : "\u52a0\u8f7d ") + a2.k;
        a5.ALLATORIxDEMO = -1;
        a5.ALLATORIxDEMO();
    }
    ...
    public void draw(int a2, int a3) {
        ...
        a4.func_73732_a(a4.v.field_71466_p, a4.y, a4.q + a4.o / 2, a4.b + 6, a5);
        if (a4.ALLATORIxDEMO != -1 && a4.ALLATORIxDEMO / 6 % 2 == 0) {
            a4.v.field_71466_p.func_175063_a("_", (float)(a4.q + (a4.o + a4.v.field_71466_p.func_78256_a(a4.y)) / 2 + 1), (float)(a4.b + 6), 0xFFFFFF);
        }
        if (a4.k) {
            a5 = a4.inBoundsOfX(a2, a3) ? 0xFFFFA0 : 0xFFFFFF;
            a4.ALLATORIxDEMO(a4.c(), a4.ALLATORIxDEMO(), 0, 66, 14, 14);
            a4.func_73732_a(a4.v.field_71466_p, "x", a4.q - 3 - 7, a4.b + 6, a5);
        }
    }
    ...
    private /* synthetic */ void ALLATORIxDEMO(int a2, int a3, int a4, int a5, int a6, int a7) {
        ...
        a8.v.field_71446_o.func_110577_a(z);
        a8.func_73729_b(a2, a3, a4, a5, a6 / 2, a7 / 2);
        a8.func_73729_b(a2 + a6 / 2, a3, a4 + 200 - a6 / 2, a5, a6 / 2, a7 / 2);
        a8.func_73729_b(a2, a3 + a7 / 2, a4, a5 + 20 - a7 / 2, a6 / 2, a7 / 2);
        a8.func_73729_b(a2 + a6 / 2, a3 + a7 / 2, a4 + 200 - a6 / 2, a5 + 20 - a7 / 2, a6 / 2, a7 / 2);
    }
    ...
    private /* synthetic */ void ALLATORIxDEMO() {
        le a2;
        a2.o = a2.v.field_71466_p.func_78256_a(a2.y) + 24;
        if (a2.o % 2 == 1) {
            ++a2.o;
        }
        a2.o = MathHelper.func_76125_a((int)a2.o, (int)82, (int)150);
        a2.q = a2.c - a2.o;
    }
    ...
    public void keyTyped(char a2, int a3) {
        ...
        if (Character.isDigit(a2) || Character.isLetter(a2)) {
            a4.m.k = a4.m.k + a2;
            a4.y = (a4.m.ALLATORIxDEMO.func_82582_d() ? "\u4fdd\u5b58 " : "\u52a0\u8f7d ") + a4.m.k;
            a4.ALLATORIxDEMO();
        }
    }
    ...
    public void backSpace() {
        ...
        if (a2.m.k.length() > 0) {
            ...
            a2.y = (a2.m.ALLATORIxDEMO.func_82582_d() ? "\u4fdd\u5b58 " : "\u52a0\u8f7d ") + a2.m.k;
            a2.ALLATORIxDEMO();
        }
    }
