...
public class Config {
    ...
    public static class ClientConfig {
        ...
        public void sync() {
            ...
            this.adaptiveCrosshairItems = new ListValue(this.config.get("general", "Adaptive Crosshair Items", new String[]{Items.SNOWBALL.getRegistryName().toString(), Items.EGG.getRegistryName().toString(), Items.EXPERIENCE_BOTTLE.getRegistryName().toString(), Items.ENDER_PEARL.getRegistryName().toString(), Items.SPLASH_POTION.getRegistryName().toString(), Items.FISHING_ROD.getRegistryName().toString(), Items.LINGERING_POTION.getRegistryName().toString()}));
