    ...
    protected final void checkConstraints(ExecutableElement method, AnnotationHandle annotation) {
        try {
            ...
            try {
                ...
                this.ap.printMessage(Diagnostic.Kind.ERROR, (CharSequence)ex.getMessage(), (Element)method, annotation.asMirror());
            }
        }
        catch (InvalidConstraintException ex) {
            this.ap.printMessage(Diagnostic.Kind.WARNING, (CharSequence)ex.getMessage(), (Element)method, annotation.asMirror(), SuppressedBy.CONSTRAINTS);
        }
    }
