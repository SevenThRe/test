...
extends AnimationBit<PlayerData> {
    ...
    public void perform(PlayerData data) {
        ...
        data.leftForeLeg.rotation.setSmoothness(0.7f).orientX(40.0f + MathHelper.cos((float)(limbSwing + 1.8f)) * foreLegSwingAmount);
        data.rightForeLeg.rotation.setSmoothness(0.7f).orientX(40.0f + MathHelper.cos((float)(limbSwing + (float)Math.PI + 1.8f)) * foreLegSwingAmount);
        ...
        data.globalOffset.slideY(MathHelper.cos((float)(limbSwing * 2.0f + 0.6f)) * 1.5f, 0.9f);
    }
}
