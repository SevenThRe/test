# AncientDreamMod-1.0(5)

Decompiled from local Minecraft mod jar for inspection and bug research.

| Field | Value |
|---|---|
| Original jar | $(F:\Program Files\tx\重生II客户端正式启动2026628\重生II客户端正式启动2026628\.minecraft\mods\AncientDreamMod-1.0(5).jar.Name) |
| Metadata source | $(System.Collections.Specialized.OrderedDictionary.source) |
| Mod ID | $(System.Collections.Specialized.OrderedDictionary.modid) |
| Version | $(System.Collections.Specialized.OrderedDictionary.version) |
| SHA256 | $sha256 |
