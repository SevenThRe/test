...
import eos.moe.ancientdream.yaml.snakeyaml.configuration.serialization.DelegateDeserialization;
import eos.moe.ancientdream.yaml.snakeyaml.configuration.serialization.SerializableAs;
...
public class ConfigurationSerialization {
    ...
    public ConfigurationSerializable deserialize(Map<String, ?> args) {
        ...
        Validate.notNull(args, (String)"Args must not be null", (Object[])new Object[0]);
