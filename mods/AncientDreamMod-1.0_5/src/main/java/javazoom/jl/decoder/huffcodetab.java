...
final class huffcodetab {
    ...
    private huffcodetab(String string, int n, int n2, int n3, int n4, int n5, int[] nArray, int[] nArray2, int[][] nArray3, int n6) {
    ...
    public static int huffman_decoder(huffcodetab huffcodetab2, int[] nArray, int[] nArray2, int[] nArray3, int[] nArray4, BitReserve bitReserve) {
        int n = Integer.MIN_VALUE;
        int n2 = 32;
        int n3 = 0;
        int n4 = 1;
        int n5 = n;
        if (huffcodetab2.val == null) {
            return 2;
        }
        if (huffcodetab2.treelen == 0) {
            nArray2[0] = 0;
            nArray[0] = 0;
            return 0;
        }
        do {
            if (huffcodetab2.val[n3][0] == 0) {
                nArray[0] = huffcodetab2.val[n3][1] >>> 4;
                nArray2[0] = huffcodetab2.val[n3][1] & 0xF;
                n4 = 0;
                break;
            }
            if (bitReserve.hget1bit() != 0) {
                while (huffcodetab2.val[n3][1] >= 250) {
                    n3 += huffcodetab2.val[n3][1];
                }
                n3 += huffcodetab2.val[n3][1];
                continue;
            }
            while (huffcodetab2.val[n3][0] >= 250) {
                n3 += huffcodetab2.val[n3][0];
            }
            n3 += huffcodetab2.val[n3][0];
        } while ((n5 >>>= 1) != 0 || n3 < 0);
        if (huffcodetab2.tablename0 == '3' && (huffcodetab2.tablename1 == '2' || huffcodetab2.tablename1 == '3')) {
            nArray3[0] = nArray2[0] >> 3 & 1;
            nArray4[0] = nArray2[0] >> 2 & 1;
            nArray[0] = nArray2[0] >> 1 & 1;
            nArray2[0] = nArray2[0] & 1;
            if (nArray3[0] != 0 && bitReserve.hget1bit() != 0) {
                nArray3[0] = -nArray3[0];
            }
            if (nArray4[0] != 0 && bitReserve.hget1bit() != 0) {
                nArray4[0] = -nArray4[0];
            }
            if (nArray[0] != 0 && bitReserve.hget1bit() != 0) {
                nArray[0] = -nArray[0];
            }
            if (nArray2[0] != 0 && bitReserve.hget1bit() != 0) {
                nArray2[0] = -nArray2[0];
            }
        } else {
            if (huffcodetab2.linbits != 0 && huffcodetab2.xlen - 1 == nArray[0]) {
                nArray[0] = nArray[0] + bitReserve.hgetbits(huffcodetab2.linbits);
            }
            if (nArray[0] != 0 && bitReserve.hget1bit() != 0) {
                nArray[0] = -nArray[0];
            }
            if (huffcodetab2.linbits != 0 && huffcodetab2.ylen - 1 == nArray2[0]) {
                nArray2[0] = nArray2[0] + bitReserve.hgetbits(huffcodetab2.linbits);
            }
            if (nArray2[0] != 0 && bitReserve.hget1bit() != 0) {
                nArray2[0] = -nArray2[0];
            }
